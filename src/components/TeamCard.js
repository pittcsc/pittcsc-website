...
function TeamCard({ bio, image, name, title, linkedIn, email }) {
  ...
  return (
    <>
      <AnimatePresence mode="wait">
        {modalOpen && (
          <Modal open={modalOpen} onClose={() => setModalOpen(false)}>
            <div className="flex flex-col items-center justify-center px-4 py-8 max-w-5xl bg-surface-raised rounded-2xl space-x-8 md:flex-row md:p-8">
              <img
      ...
      <div
        className={`relative p-8 w-64 bg-surface-raised rounded-2xl focus:outline-none hover:shadow-lg shadow-md ${bio !== undefined ? "cursor-pointer" : "cursor-default"
